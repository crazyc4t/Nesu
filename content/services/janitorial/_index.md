...
description: "Professional janitorial cleaning for commercial buildings, strata properties, and facilities in Metro Vancouver"
layout: "simple"
...
.service-hero {
  width: 100%;
  height: 400px;
  background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('/images/service/cleaning2.jpg') center/cover;
  display: flex;
  align-items: center;
...
Your building stays spotless. Your tenants stay happy. From daily cleaning to deep sanitization, we handle every detail so you don't have to.
...
- Gym facilities
- Carpet, upholstery, and floor maintenance
- Marble and natural stone care
- Pressure washing for exterior areas
- Site entrances, stairways and lobbies
- Washrooms
- Elevators and common corridors
- Indoor & outdoor amenities
- Strata owned guest suites
- Property exterior
- Outdoor amenities and courtyards
- Parkade landing areas
- Garbage rooms
...
<div style="text-align: center; margin: 60px 0; padding: 40px; background: rgba(80, 0, 80, 0.08); border: 2px solid rgba(80, 0, 80, 0.3); border-radius: 12px;">
  ...
  <a href="/contact/" style="background: rgb(80,0,80); color: white; padding: 16px 40px; border-radius: 4px; text-decoration: none; font-weight: 600; font-size: 1.1em; display: inline-block;">Get a Free Quote</a>
</div>
